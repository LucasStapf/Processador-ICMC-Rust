...
mod imp {
    ...
    #[template(resource = "/br/com/processador/processor-screen.ui")]
    pub struct ProcessorScreen {
        pub pixbuf: Rc<RefCell<Vec<Pixelmap>>>,
        pub charmap: Rc<RefCell<crate::files::charmap::Charmap>>,
    }

    impl Default for ProcessorScreen {
        fn default() -> Self {
    ...
    impl ObjectSubclass for ProcessorScreen {
        const NAME: &'static str = "ProcessorScreen";
        type Type = super::ProcessorScreen;
    ...
    impl ObjectImpl for ProcessorScreen {
        fn constructed(&self) {
    ...
    impl WidgetImpl for ProcessorScreen {}

    impl DrawingAreaImpl for ProcessorScreen {}
}
